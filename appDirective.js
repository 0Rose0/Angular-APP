app.directive('appInfo', function() { 
  return { 
    ...
    templateUrl: 'js/directives/appInfo.html' //templateUrl specifies the HTML to use in order to display the data in scope.info. Here we use the HTML in js/directives/appInfo.html.
  }; 
});
